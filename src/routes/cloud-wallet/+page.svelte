<script lang="ts">
  ...
  >
    ...
    {#if form?.success}
      <!-- this message is ephemeral; it exists because the page was rendered in
         response to a form submission. it will vanish if the user reloads -->
      <p class="pt-2">The payment was successful. Here is your <a class="bg-red-500 text-white rounded px-5" href="https://whatsonchain.com/tx/{form?.payment}">transaction</a></p>
    {/if}
  </div>